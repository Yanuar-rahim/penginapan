...
$hero_image_url = $hero_image['value'] ?? 'default.jpg'; // Tambahkan fallback untuk hero image
            ...
            <section class="main-content">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="input-field">
                        ...
                        <img src="../assets/img/<?= $hero_image_url ?>" alt="<?= $hero_image_url ?>" style="width: 200px; height: 120px; margin: 20px 0;">
